...
4. ✅ BR-015 — Confirmation/undo pattern for void/archive (void and archive both use `AlertDialog`; archive adds an Undo toast via PR #23, pending merge).
