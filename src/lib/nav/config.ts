...
export const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      {
        href: '/dashboard/coming-soon/month-review',
        labelKey: 'nav.monthReview',
        icon: CalendarCheck,
        phase: 'beta',
        descriptionKey: 'comingSoon.descriptions.monthReview',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: '/dashboard/coming-soon/debt-planner',
        labelKey: 'nav.debtPlanner',
        icon: Calculator,
        phase: 'beta',
        descriptionKey: 'comingSoon.descriptions.debtPlanner',
      },
  ...
  },
  {
    ...
    items: [
      {
        href: '/dashboard/coming-soon/reports',
        labelKey: 'nav.reports',
        icon: BarChart3,
        phase: 'soon',
        descriptionKey: 'comingSoon.descriptions.reports',
      },
      {
        href: '/dashboard/coming-soon/trends',
        labelKey: 'nav.trends',
        icon: LineChart,
        phase: 'soon',
        descriptionKey: 'comingSoon.descriptions.trends',
      },
      {
        href: '/dashboard/coming-soon/cash-flow',
        labelKey: 'nav.cashFlow',
        icon: Waves,
        phase: 'soon',
        descriptionKey: 'comingSoon.descriptions.cashFlow',
      },
    ],
  },
  {
