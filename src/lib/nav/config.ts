  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Tags,
        phase: 'alpha',
        hint: 'Free-form labels to slice transactions across categories',
      },
      {
        ...
        icon: StickyNote,
        phase: 'alpha',
        hint: 'Dated reminders and context, separate from transactions',
      },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: CalendarRange,
        phase: 'alpha',
        hint: 'Which days of the month you actually spend',
      },
    ],
  },
  {
