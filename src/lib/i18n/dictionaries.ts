...
export const en = {
  ...
  dashboard: {
    ...
    cashFlowSpent: 'Spent',
    cashFlowSaved: 'Saved',
    cashFlowSpentShare: '{spent} of income spent · {saved} saved',
    cashFlowNoIncome: 'No income recorded this month yet',
    vsMonth: 'vs {month}',
    paceTitle: 'Spending',
    paceLessSameDay: '{amount} less than by this day in {month}',
    paceMoreSameDay: '{amount} more than by this day in {month}',
    paceLessMonth: '{amount} less than in {month}',
    paceMoreMonth: '{amount} more than in {month}',
    paceSame: 'Same pace as {month}',
    paceDay: 'Day {day}',
    paceAria:
    ...
    healthHowCalculated: 'How it’s calculated',
    healthDetails: 'Details',
    healthBudgetUsed: 'Budget used',
    healthNoIncome: 'No income yet',
    healthPoints: '{points} pts × {weight}',
    healthNoBudget: 'No budget this month, so the score is savings only.',
    healthWeakest: 'Weakest',
    healthActionRaiseSavings:
      'Savings is holding your score back. Spending less than you earn raises it.',
    healthActionReinInBudget:
      'Budget overspending is holding your score back. Getting back under plan raises it.',
    healthActionRecordIncome:
      'No income is recorded this month, so savings counts as neutral (50 pts).',
    healthActionSetBudget:
      'Savings is maxed out. Add a budget to also track how well you stick to a plan.',
    healthActionKeepGoing: 'Both parts are at 100. Keep it up.',
    healthCtaReviewExpenses: 'Review expenses',
    healthCtaReviewBudget: 'Review budget',
    healthCtaReviewIncome: 'Review income',
    healthCtaSetBudget: 'Set a budget',
    healthThresholdSavings:
      'Savings rate: −20% or less → 0 pts, 0% → 50, +20% or more → 100.',
    healthThresholdBudget:
      'Budget: up to 100% used → 100 pts, falling to 0 at 150% used.',
    healthThresholdWeights:
      'Weights: savings {savings}, budget {budget}. Without a budget, savings counts 100%.',
    healthThresholdGrades:
      'Grades: A+ 90+, A 80+, B+ 70+, B 60+, C+ 50+, C 40+, D below 40.',
    insightsTitle: 'Insights',
    insightsDescription: 'Derived from your real data.',
    insightsBasis: 'Based on {month}: your transactions, budget and account balances.',
    ...
    insightLiabilitiesDown:
      'Balances owed on your accounts went down {amount} versus last month.',
    insightTopCategory: '{category} is your top expense at {amount}.',
    insightActionViewTransactions: 'View transactions',
    insightActionReviewMonth: 'Review month',
    insightActionViewAccounts: 'View accounts',
    ...
    scheduledTitle: 'Scheduled activity',
    scheduledEmpty: 'Nothing scheduled. Recurring income and bills will show up here.',
    heroAssets: 'Assets',
...
export const es: DeepStringify<typeof en> = {
  ...
  dashboard: {
    ...
    cashFlowIncome: 'Ingresos',
    cashFlowSpent: 'Gastado',
    cashFlowSaved: 'Ahorrado',
    cashFlowSpentShare: '{spent} de los ingresos gastado · {saved} ahorrado',
    cashFlowNoIncome: 'Aún no hay ingresos registrados este mes',
    vsMonth: 'vs {month}',
    paceTitle: 'Gastos',
    paceLessSameDay: '{amount} menos que a esta altura de {month}',
    paceMoreSameDay: '{amount} más que a esta altura de {month}',
    paceLessMonth: '{amount} menos que en {month}',
    paceMoreMonth: '{amount} más que en {month}',
    paceSame: 'Mismo ritmo que en {month}',
    paceDay: 'Día {day}',
    paceAria:
    ...
    setupTitle: 'Termina de configurar',
    budgetTotal: 'Total',
    ...
    healthHowCalculated: 'Cómo se calcula',
    healthDetails: 'Detalles',
    healthBudgetUsed: 'Presupuesto usado',
    healthNoIncome: 'Sin ingresos aún',
    healthPoints: '{points} pts × {weight}',
    healthNoBudget: 'No hay presupuesto este mes, así que el puntaje depende solo del ahorro.',
    healthWeakest: 'Punto más débil',
    healthActionRaiseSavings:
      'El ahorro está frenando tu puntaje. Gastar menos de lo que ganas lo sube.',
    healthActionReinInBudget:
      'El sobregasto del presupuesto está frenando tu puntaje. Volver a estar dentro del plan lo sube.',
    healthActionRecordIncome:
      'No hay ingresos registrados este mes, así que el ahorro cuenta como neutral (50 pts).',
    healthActionSetBudget:
      'El ahorro ya está al máximo. Agrega un presupuesto para también medir qué tan bien te apegas a un plan.',
    healthActionKeepGoing: 'Ambas partes están en 100. Sigue así.',
    healthCtaReviewExpenses: 'Revisar gastos',
    healthCtaReviewBudget: 'Revisar presupuesto',
    healthCtaReviewIncome: 'Revisar ingresos',
    healthCtaSetBudget: 'Configurar un presupuesto',
    healthThresholdSavings:
      'Tasa de ahorro: −20% o menos → 0 pts, 0% → 50, +20% o más → 100.',
    healthThresholdBudget:
      'Presupuesto: hasta 100% usado → 100 pts, bajando a 0 en 150% usado.',
    healthThresholdWeights:
      'Ponderación: ahorro {savings}, presupuesto {budget}. Sin presupuesto, el ahorro cuenta 100%.',
    healthThresholdGrades:
      'Calificaciones: A+ 90+, A 80+, B+ 70+, B 60+, C+ 50+, C 40+, D menos de 40.',
    insightsTitle: 'Perspectivas',
    insightsDescription: 'Derivados de tus datos reales.',
    insightsBasis: 'Basado en {month}: tus transacciones, presupuesto y saldos de cuentas.',
    ...
    insightLiabilitiesDown:
      'Los saldos adeudados en tus cuentas bajaron {amount} frente al mes pasado.',
    insightTopCategory: '{category} es tu mayor gasto con {amount}.',
    insightActionViewTransactions: 'Ver transacciones',
    insightActionReviewMonth: 'Revisar el mes',
    insightActionViewAccounts: 'Ver cuentas',
    ...
    scheduledTitle: 'Actividad programada',
    scheduledEmpty: 'Nada programado. Los ingresos y pagos recurrentes aparecerán aquí.',
    heroAssets: 'Activos',
...
export const fr: DeepStringify<typeof en> = {
  ...
  dashboard: {
    ...
    cashFlowSpent: 'Dépensé',
    cashFlowSaved: 'Épargné',
    cashFlowSpentShare: '{spent} des revenus dépensés · {saved} épargnés',
    cashFlowNoIncome: 'Aucun revenu enregistré ce mois-ci pour l’instant',
    vsMonth: 'vs {month}',
    paceTitle: 'Dépenses',
    paceLessSameDay: '{amount} de moins qu’à la même date en {month}',
    paceMoreSameDay: '{amount} de plus qu’à la même date en {month}',
    paceLessMonth: '{amount} de moins qu’en {month}',
    paceMoreMonth: '{amount} de plus qu’en {month}',
    paceSame: 'Même rythme qu’en {month}',
    paceDay: 'Jour {day}',
    paceAria:
    ...
    healthHowCalculated: 'Comment il est calculé',
    healthDetails: 'Détails',
    healthBudgetUsed: 'Budget utilisé',
    healthNoIncome: 'Aucun revenu pour l’instant',
    healthPoints: '{points} pts × {weight}',
    healthNoBudget: 'Aucun budget ce mois-ci, donc le score ne tient compte que de l’épargne.',
    healthWeakest: 'Point le plus faible',
    healthActionRaiseSavings:
      'L’épargne pénalise votre score. Dépenser moins que ce que vous gagnez le fait monter.',
    healthActionReinInBudget:
      'Le dépassement du budget pénalise votre score. Revenir dans le plan le fait monter.',
    healthActionRecordIncome:
      'Aucun revenu n’est enregistré ce mois-ci, donc l’épargne compte comme neutre (50 pts).',
    healthActionSetBudget:
      'L’épargne est déjà au maximum. Ajoutez un budget pour aussi suivre votre respect d’un plan.',
    healthActionKeepGoing: 'Les deux parties sont à 100. Continuez comme ça.',
    healthCtaReviewExpenses: 'Vérifier les dépenses',
    healthCtaReviewBudget: 'Vérifier le budget',
    healthCtaReviewIncome: 'Vérifier les revenus',
    healthCtaSetBudget: 'Définir un budget',
    healthThresholdSavings:
      'Taux d’épargne : −20% ou moins → 0 pt, 0% → 50, +20% ou plus → 100.',
    healthThresholdBudget:
      'Budget : jusqu’à 100% utilisé → 100 pts, jusqu’à 0 à 150% utilisé.',
    healthThresholdWeights:
      'Pondération : épargne {savings}, budget {budget}. Sans budget, l’épargne compte à 100%.',
    healthThresholdGrades:
      'Notes : A+ 90+, A 80+, B+ 70+, B 60+, C+ 50+, C 40+, D en dessous de 40.',
    insightsTitle: 'Perspectives',
    insightsDescription: 'Dérivées de vos données réelles.',
    insightsBasis: 'Basé sur {month} : vos transactions, votre budget et les soldes de vos comptes.',
    ...
    insightLiabilitiesDown:
      'Les soldes dus sur vos comptes ont baissé de {amount} par rapport au mois dernier.',
    insightTopCategory: '{category} est votre principale dépense à {amount}.',
    insightActionViewTransactions: 'Voir les transactions',
    insightActionReviewMonth: 'Vérifier le mois',
    insightActionViewAccounts: 'Voir les comptes',
    ...
    scheduledTitle: 'Activité programmée',
    scheduledEmpty: 'Rien de programmé. Les revenus et factures récurrents apparaîtront ici.',
    heroAssets: 'Actifs',
