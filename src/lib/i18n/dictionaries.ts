...
export const en = {
  ...
  accounts: {
    ...
    noActiveDesc: 'Create your first account to start tracking balances.',
...
export const es: DeepStringify<typeof en> = {
  ...
  accounts: {
    ...
    noActiveDesc: 'Crea tu primera cuenta para empezar a registrar saldos.',
...
export const fr: DeepStringify<typeof en> = {
  ...
  accounts: {
    ...
    noActiveDesc: 'Créez votre premier compte pour commencer à suivre vos soldes.',
